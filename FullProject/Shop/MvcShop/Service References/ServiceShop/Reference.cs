...
namespace MvcShop.ServiceShop {
    ...
    public interface IServiceShop {
        ...
        int CreateRecept(ShopModel.Entities.Recept recept);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceShop/LoadItemInSkladByIngradient", ReplyAction="http://tempuri.org/IServiceShop/LoadItemInSkladByIngradientResponse")]
        ShopModel.Entities.ItemInSklad LoadItemInSkladByIngradient(int id);
    ...
    public partial class ServiceShopClient : System.ServiceModel.ClientBase<MvcShop.ServiceShop.IServiceShop>, MvcShop.ServiceShop.IServiceShop {
        ...
        public int CreateRecept(ShopModel.Entities.Recept recept) {
        ...
        public ShopModel.Entities.ItemInSklad LoadItemInSkladByIngradient(int id) {
            return base.Channel.LoadItemInSkladByIngradient(id);
        }
